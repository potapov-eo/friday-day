...
describe('Cards-reducer test', () => {
    it('correct Cards should be added', () => {
        const cardPacks = [{
            _id: "string",
            cardsPack_id: "string",
            user_id: "string",
    ...
    it('correct Total cards count should be added', () => {
    ...
    it('correct pagination property should be added', () => {
    ...
    it('correct card grade should be added', () => {
